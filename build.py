...
class BuildExe:
    def __init__(self):
        ...
        #Auhor of program
        self.author_name = "Nadav Felman"
        self.author_email = "nadavf181@gamil.com"
        self.copyright = "Copyright (c) 2018 Nadav Felman."
        ...
        #DLL Excludes
        self.exclude_dll = []
        #python scripts (strings) to be i ncluded, seperated by a comma
        self.extra_scripts = ['numpy', 'math', 'random', 'interface', 'game', 'connection']
